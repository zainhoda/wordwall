...
var $author$project$Main$DoneAdding = {$: 3};
var $author$project$Main$doneButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('button is-danger'),
			$elm$html$Html$Events$onClick($author$project$Main$DoneAdding)
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('Done Adding Words')
		]));
...
var $author$project$Main$wordList = function (listOfWords) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
...
var $author$project$Main$wordInputView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
